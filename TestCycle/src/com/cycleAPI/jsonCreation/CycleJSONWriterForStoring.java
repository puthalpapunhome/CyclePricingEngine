...
public class CycleJSONWriterForStoring {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		/*
		 * Jan 2016 - Nov 2016 Dec 2016 - Nov 2017 Dec 2017 - Nov 2018 Dec 2018
		 * - Nov 2019 Dec 2019 - Nov 2020
		 */
		int year = 2016;
		...
		for (int i = 1; i <= 5; i++) {
			if (i == 1)
				dateSlicingBuilder.add("Jan " + (year + i) + " - Dec "
						+ (year + i) + "", getWholeCycleData(annualRate * i));
			else
				dateSlicingBuilder.add("Jan " + (year + i) + " - Nov "
						+ (year + i) + "", getWholeCycleData(annualRate * i));
		}
	...
	public static JsonObjectBuilder getWholeCycleData(double rate) {
		...
		handleBuilder
				.add("handlebar_grip",
						wholeCycle.getHandleBarWithBrakes().getHandlebar_grip())
				.add("handlebar_grip",
						wholeCycle.getHandleBarWithBrakes().getHandlebar_grip())
				.add("head_tube",
						wholeCycle.getHandleBarWithBrakes().getHead_tube())
				.add("shock_absorber",
						wholeCycle.getHandleBarWithBrakes().getShock_absorber())
				.add("front_brakes",
						wholeCycle.getHandleBarWithBrakes().getFront_brakes())
				.add("fork", wholeCycle.getHandleBarWithBrakes().getFork());

		seatBuilder.add("saddle", wholeCycle.getSeating().getSaddle()).add(
				"seat_post", wholeCycle.getSeating().getSeat_post());
		...
		chainBuilder.add("chain", wholeCycle.getChainAssembly().getChain())
				.add("chain_ring",
						wholeCycle.getChainAssembly().getChain_ring());
	...
	public static WholeCycle createCycle(double rate) {
		...
		System.out.println(Double.parseDouble(f.format(Math.random()
				* (260 - 195) + 195)));

		ChainAssembly chainAssembly = new ChainAssembly();
		chainAssembly.setChain(Double.parseDouble(f.format(Math.random()
				* ((200 + (rate * 200)) - (((rate * 150) + 50) + 1))
				+ ((rate * 150) + 150))));
		chainAssembly
				.setChain_ring(Double.parseDouble(f.format(Math.random()
						* (((150 + (rate * 150)) - (((rate * 100) + 100) + 1)) + ((rate * 100) + 100)))));

		Frame frame = new Frame();
		frame.setChain_stay(Double.parseDouble(f.format(Math.random()
				* (((950 + (rate * 950)) - (((rate * 900) + 900) + 1)) + ((rate * 900) + 900)))));
		frame.setDown_tube(Double.parseDouble(f.format(Math.random()
				* (((850 + (rate * 850)) - (((rate * 800) + 800) + 1)) + ((rate * 800) + 800)))));
		frame.setSeat_stay(Double.parseDouble(f.format(Math.random()
				* (((970 + (rate * 970)) - (((rate * 900) + 900) + 1)) + ((rate * 900) + 900)))));
		frame.setSeat_tube(Double.parseDouble(f.format(Math.random()
				* (((850 + (rate * 850)) - (((rate * 800) + 800) + 1)) + ((rate * 800) + 800)))));
		frame.setTop_tube(Double.parseDouble(f.format(Math.random()
				* (((850 + (rate * 850)) - (((rate * 820) + 820) + 1)) + ((rate * 820) + 820)))));

		HandleBarWithBrakes handle = new HandleBarWithBrakes();
		handle.setFork(Double.parseDouble(f.format(Math.random()
				* (((500 + (rate * 500)) - (((rate * 450) + 450) + 1)) + ((rate * 450) + 450)))));
		handle.setFront_brakes(Double.parseDouble(f.format(Math.random()
				* (((450 + (rate * 450)) - (((rate * 400) + 400) + 1)) + ((rate * 400) + 400)))));
		handle.setHandlebar_grip(Double.parseDouble(f.format(Math.random()
				* (((500 + (rate * 500)) - (((rate * 450) + 450) + 1)) + ((rate * 450) + 450)))));
		handle.setHead_tube(Double.parseDouble(f.format(Math.random()
				* (((500 + (rate * 500)) - (((rate * 450) + 450) + 1)) + ((rate * 450) + 450)))));
		handle.setShock_absorber(Double.parseDouble(f.format(Math.random()
				* (((150 + (rate * 150)) - (((rate * 100) + 100) + 1)) + ((rate * 100) + 100)))));

		Seating seat = new Seating();
		seat.setSaddle(Double.parseDouble(f.format(Math.random()
				* (((500 + (rate * 500)) - (((rate * 450) + 450) + 1)) + ((rate * 450) + 450)))));
		seat.setSeat_post(Double.parseDouble(f.format(Math.random()
				* (((200 + (rate * 200)) - (((rate * 150) + 150) + 1)) + ((rate * 150) + 150)))));

		Wheels wheels = new Wheels();
		wheels.setRim(Double.parseDouble(f.format(Math.random()
				* (((300 + (rate * 300)) - (((rate * 250) + 250) + 1)) + ((rate * 250) + 250)))));
		wheels.setSpokes(Double.parseDouble(f.format(Math.random()
				* (((200 + (rate * 200)) - (((rate * 150) + 150) + 1)) + ((rate * 150) + 150)))));
		wheels.setTube(Double.parseDouble(f.format(Math.random()
				* (((200 + (rate * 200)) - (((rate * 150) + 150) + 1)) + ((rate * 150) + 150)))));
		wheels.setTyre(Double.parseDouble(f.format(Math.random()
				* (((300 + (rate * 300)) - (((rate * 250) + 250) + 1)) + ((rate * 250) + 250)))));
