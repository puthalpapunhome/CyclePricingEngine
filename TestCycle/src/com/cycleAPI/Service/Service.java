...
public class Service {
	...
	public String gerPricingReport(double tolatPrice, WholeCycle whole,
		...
		try {
			...
			sb.append("components are below with prices\n");
			sb.append("--------------------\n");
	...
	public String readAndDisplayGivenJsonComponents(JSONObject jsonObject) {
		try {
			...
			JSONArray chain_assembly = (JSONArray) jsonObject
					.get("chain_assembly");
